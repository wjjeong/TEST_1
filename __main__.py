...
def run_sc(p_file_nm,p_sql_id):
    ...
    # 2. mapping_sql
    mapping_sql2(p_file_nm, p_sql_id)
...
def get_conn(p_db_type):
    ...
    if p_db_type == 'PGS':
        # JDBC_DRIVER = os.environ["JAVA_HOME"] + "\\lib\\postgresql-42.1.1.jre7.jar"
        # print(JDBC_DRIVER )
        # JDBC_LIBS = os.environ["JAVA_HOME"] + "\\lib"
        # conn = jaydebeapi.connect("org.postgresql.Driver", "jdbc:postgresql:thin:@192.168.59.103:5432:postgres",["admin", "admin"], JDBC_DRIVER, [])
        # conn = jaydebeapi.connect("org.postgresql.Driver", "jdbc:postgresql:thin:@192.168.59.103:5432:postgres",["admin", "admin"], JDBC_DRIVER, [])
        # conn = psycopg2.connect(dbname="postgres", user="admin", password="admin",host= "192.168.59.103",port = "5432")
...
#         print(JDBC_DRIVER)
#
#         # conn = jaydebeapi.connect("com.tmax.tibero.jdbc.TbDriver","jdbc:tibero:thin:sys/tibero@localhost:7069/DBTBROT","C:\FOI\tibero5-jdbc.jar")
#         # conn = jaydebeapi.connect("com.tmax.tibero.jdbc.TbDriver",["jdbc:tibero:thin:@localhost:7069:DBTBROT","sys","tibero"],'"C:\FOI\tibero5-jdbc.jar")
#         # conn = jaydebeapi.connect("com.tmax.tibero.jdbc.TbDriver", "jdbc:tibero:thin:sys//tibero@localhost:7069:DBTBROT",'', "C:\FOI\tibero5-jdbc.jar")
#         # conn = jaydebeapi.connect("com.tmax.tibero.jdbc.TbDriver","jdbc:tibero:thin:sys//tibero@localhost:7069:DBTBROT",'',"C:\FOI\tibero5-jdbc.jar")
#         # conn = jaydebeapi.connect('oracle.jdbc.driver.OracleDriver','jdbc:oracle:thin:user/password@//DB_HOST_IP:1521/DB_NAME')
#         # conn = jaydebeapi.connect('com.tmax.tibero.jdbc.TbDriver','jdbc:tibero:thin:sys/tibero@localhost:7069/DBTBROT','',"C:\FOI\tibero5-jdbc.jar")
#         # conn = jaydebeapi.connect('com.tmax.tibero.jdbc.TbDriver','jdbc:tibero:thin:sys/tibero@localhost:7069/DBTBROT','',"C:\FOI\tibero5-jdbc.jar")
#         # conn = jaydebeapi.connect("com.tmax.tibero.jdbc.TbDriver","jdbc:tibero:thin:sys/tibero@localhost:7069/DBTBROT")
#         # conn = jaydebeapi.connect("com.tmax.tibero.jdbc.TbDriver","jdbc:tibero:thin:sys/tibero@localhost:7069/DBTBROT")
#         # conn = jaydebeapi.connect ('com.tmax.tibero.jdbc.TbDriver'['jdbc:tibero:thin://localhost:7069/DBTBROT','sys','tibero'],'C:\FOI\tibero5-jdbc.jar')
#         # conn = jaydebeapi.connect ('com.tmax.tibero.jdbc.TbDriver'['jdbc:tibero:thin://localhost:7069/DBTBROT','sys','tibero'],'C:\FOI\tibero5-jdbc.jar')
#
#         conn = jaydebeapi.connect("com.tmax.tibero.jdbc.TbDriver", "jdbc:tibero:thin:@localhost:7069:DBTBROT",
#                                   ["sys", "tibero"], JDBC_DRIVER, [])
#         curs = conn.cursor()
#
...
#         # curs.fetchall()
#         curs.execute("SELECT * FROM ALL_D_TUN.B2EN_SC_SQL_TEXT where rownum <= 2")
...
def analyze_sql_step2(p_file_nm,p_sql_id):
    ...
    # mapping_sql2(v_file_nm, v_sql_id)
...
def mapping_sql2(p_file_nm,p_sql_id):
    conn = get_conn("PGS")
...
# mapping_sql2('w_insa_1_tong' ,'d_insa_1_tong3')
